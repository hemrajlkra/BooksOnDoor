        ...
        public bool SendMail(MailData mailData)
        {
            try
            {
                using (MimeMessage emailMessage = new MimeMessage())
                {
                    ...
                    MailboxAddress emailTo = new MailboxAddress(mailData.EmailToName, mailData.OrgEmailId);
                    emailMessage.To.Add(emailTo);

                    emailMessage.Cc.Add(new MailboxAddress("Cc Receiver", mailData.EmailToId));
